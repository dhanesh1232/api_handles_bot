...
router.get("/clients/:code", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
// 1b. GET CLIENT COUNT
router.get("/clients/count", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.post("/clients", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.get("/clients/:code/config", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.patch("/clients/:code/config", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.get("/clients/:code/secrets", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
    ...
    if (secrets.customSecrets) {
      for (const [key] of Array.from(secrets.customSecrets.entries())) {
...
router.post("/clients/:code/secrets", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.get("/clients/:code/datasource", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.post("/clients/:code/datasource", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
    const clientCode = (req.params.code as string).toUpperCase();
...
router.patch("/clients/:id/identity", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
...
router.post("/clients/:code/api-key", verifyCoreToken, async (req: Request, res: Response) => {
  await dbConnect("services");
  try {
    const client = await Client.findOne({
      clientCode: (req.params.code as string).toUpperCase(),
