...
export const compressMedia = async (buffer, mimeType, id) => {
...
export const getR2Client = (secrets) => {
...
export const uploadBufferToR2 = async (buffer, mimeType, filename, secrets) => {
